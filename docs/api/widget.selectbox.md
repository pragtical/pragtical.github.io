...
@*param* `item_data`: `table<integer, string|integer|fun(self: any, row: any, x: any, y: any, font: any, color: any, only_calc: any)|`[`renderer.color`](/docs/api/renderer#renderercolor)`|`[`renderer.font`](/docs/api/renderer#rendererfont)`...(+2)>`
...
@*param* `font`: `string|`[`renderer.font`](/docs/api/renderer#rendererfont)`|`[`widget.fontreference`](/docs/api/widget#widgetfontreference) — Default is style.font

@*param* `overflow_chars?`: `string` — Default is '...'

@*return* `chopped_text`: `string`

@*return* `overflows`: `boolean` — True if the text overflows
