...
```lua
(method) widget.itemslist:add_item(text: string|table<integer, string|integer|renderer.color|renderer.font|widget.colorreference...(+1)>, data: any)
```
...
```lua
(method) widget.itemslist:edit_item(idx: integer, text: string|table<integer, string|integer|renderer.color|renderer.font|widget.colorreference...(+1)>, data: any)
```
...
```lua
(method) widget.itemslist:get_items()
...
```lua
(method) widget.itemslist:new(parent: widget)
```
...
```lua
(method) widget.itemslist:remove_item(idx: integer)
```
...
```lua
(method) widget.itemslist:update_size_position()
```
