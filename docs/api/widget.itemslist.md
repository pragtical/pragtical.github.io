...
```lua
(method) widget.itemslist:add_item(text: string|table<integer, string|integer|renderer.color|renderer.font|widget.fontreference>, data: any)
```
...
```lua
(method) widget.itemslist:edit_item(idx: integer, text: string|table<integer, string|integer|renderer.color|renderer.font|widget.fontreference>, data: any)
```
