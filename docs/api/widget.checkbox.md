...
```lua
(method) widget.checkbox:get_box_rect()
  -> number
  2. number
  3. number
  4. number
...
```lua
(method) widget.checkbox:is_checked()
  -> boolean
```
...
```lua
(method) widget.checkbox:new(parent: widget, label: string)
```
...
```lua
(method) widget.checkbox:on_checked(checked: boolean)
```
...
```lua
(method) widget.checkbox:on_click()
```
...
```lua
(method) widget.checkbox:on_mouse_enter(...any)
```
...
```lua
(method) widget.checkbox:on_mouse_leave(...any)
```
...
```lua
(method) widget.checkbox:set_checked(checked: boolean)
```
...
```lua
(method) widget.checkbox:set_label(text: string)
```
...
```lua
(method) widget.checkbox:update_size_position()
```
