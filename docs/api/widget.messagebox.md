...
@*param* `title`: `string|table<integer, string|integer|`[`renderer.color`](/docs/api/renderer#renderercolor)`|`[`renderer.font`](/docs/api/renderer#rendererfont)`|`[`widget.colorreference`](/docs/api/widget#widgetcolorreference)`...(+1)>`

@*param* `message`: `string|table<integer, string|integer|`[`renderer.color`](/docs/api/renderer#renderercolor)`|`[`renderer.font`](/docs/api/renderer#rendererfont)`|`[`widget.colorreference`](/docs/api/widget#widgetcolorreference)`...(+1)>`

@*param* `icon_color?`: [`renderer.color`](/docs/api/renderer#renderercolor) — Array of bytes that represents a color used by the rendering functions.

@*param* `on_close?`: `fun(self: `[`widget.messagebox`](/docs/api/widget.messagebox)`, button_id: integer, button: `[`widget.button`](/docs/api/widget.button)`)`
...
@*param* `button_or_label`: `string|`[`widget.button`](/docs/api/widget.button)
...
@*param* `button`: [`widget.button`](/docs/api/widget.button)
