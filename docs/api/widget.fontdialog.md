...
```lua
(method) widget.fontdialog:get_font()
  -> widget.fontslist.font
```

@*return*: [`widget.fontslist.font`](/docs/api/widget.fontslist#widgetfontslistfont)
...
```lua
(method) widget.fontdialog:get_options()
  -> widget.fontdialog.fontoptions
```

@*return*: [`widget.fontdialog.fontoptions`](/docs/api/widget.fontdialog#widgetfontdialogfontoptions)
...
```lua
(method) widget.fontdialog:new(font?: widget.fontslist.font, options?: widget.fontdialog.fontoptions)
```
...
@*param* `options?`: [`widget.fontdialog.fontoptions`](/docs/api/widget.fontdialog#widgetfontdialogfontoptions)
...
```lua
(method) widget.fontdialog:on_save(font: widget.fontslist.font, options: widget.fontdialog.fontoptions)
```
...
```lua
(method) widget.fontdialog:set_font(font: widget.fontslist.font)
```
...
```lua
(method) widget.fontdialog:set_options(options: widget.fontdialog.fontoptions)
```
...
```lua
(method) widget.fontdialog:update_preview()
```
...
```lua
(method) widget.fontdialog:update_size_position()
```
