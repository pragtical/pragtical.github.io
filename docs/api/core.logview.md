...
@*return* `iterator`: `fun():integer, table, number, number, number, number` — Iterator yielding: index, item, x, y, width, height
...
@*return* `name`: `string` — Always returns "Log"
...
@*return* `handled`: `boolean` — Always returns true
