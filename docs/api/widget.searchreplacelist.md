...
```lua
(field) hovered_checkbox: boolean
```
...
```lua
(field) hovered_expander: boolean
```
...
if true enables syntax highlight for searches
...
## widget.searchreplacelist.lineposition
...
```lua
(method) widget.searchreplacelist:apply_replacement(position: integer)
```
...
```lua
(method) widget.searchreplacelist:clear()
```
...
```lua
(method) widget.searchreplacelist:contract(position: integer)
```
...
```lua
(method) widget.searchreplacelist:draw()
  -> boolean
```
...
```lua
(method) widget.searchreplacelist:draw_checkbox(checked: any, hovered: any, x: any, y: any, lh: any)
  -> unknown
```
...
```lua
(method) widget.searchreplacelist:each_file()
  -> fun():integer, widget.searchreplacelist.file
```
...
```lua
(method) widget.searchreplacelist:each_visible_item()
  -> fun():integer, widget.searchreplacelist.item, number, number, number, number
```
...
```lua
(method) widget.searchreplacelist:expand(position: integer, count_results: any)
```
...
```lua
(method) widget.searchreplacelist:get_checkbox_size(y?: number)
  -> w: number
  2. h: number
  3. y: number
```
...
```lua
(method) widget.searchreplacelist:get_h_scrollable_size()
  -> size: number
```
...
```lua
(method) widget.searchreplacelist:get_line_height()
  -> height: number
```
...
```lua
(method) widget.searchreplacelist:get_scrollable_size()
  -> size: number
```
...
```lua
(method) widget.searchreplacelist:get_selected()
  -> (widget.searchreplacelist.item)?
```
...
```lua
(method) widget.searchreplacelist:get_visible_items_range()
  -> first: integer
  2. last: integer
```
...
```lua
(method) widget.searchreplacelist:new(parent: widget, replacement?: string, search_regex?: string, case_sensitive?: boolean)
```
...
```lua
(method) widget.searchreplacelist:on_item_click(item: widget.searchreplacelist.item, clicks: integer)
```
...
```lua
(method) widget.searchreplacelist:on_mouse_moved(mx: number, my: number, ...any)
  -> boolean
```
...
```lua
(method) widget.searchreplacelist:on_mouse_pressed(button: "left"|"right", x: number, y: number, clicks: integer)
  -> boolean
```
...
```lua
(method) widget.searchreplacelist:scroll_to_selected()
```
...
```lua
(method) widget.searchreplacelist:select_next()
  -> (widget.searchreplacelist.item)?
```
...
```lua
(method) widget.searchreplacelist:select_prev()
  -> (widget.searchreplacelist.item)?
```
...
```lua
(method) widget.searchreplacelist:set_search_regex(search_regex?: string, case_sensitive?: boolean)
```
...
```lua
(method) widget.searchreplacelist:toggle_check(pos: integer)
```
...
```lua
(method) widget.searchreplacelist:toggle_expand(position: integer)
```
