...
```lua
(method) widget.inputdialog:new(title: string, message: string, text: string)
```
...
```lua
(method) widget.inputdialog:on_save(value: string)
```
...
```lua
(method) widget.inputdialog:update_size_position()
```
