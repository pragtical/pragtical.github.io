...
```lua
(method) widget.progressbar:draw()
  -> boolean
```
...
```lua
(method) widget.progressbar:get_percent()
  -> number
```
...
```lua
(method) widget.progressbar:new(parent: widget, percent: number, width: number)
```
...
```lua
(method) widget.progressbar:set_percent(percent: number)
```
...
```lua
(method) widget.progressbar:update()
  -> boolean
```
