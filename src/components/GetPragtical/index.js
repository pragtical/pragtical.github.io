...
const ReleaseList = [
    ...
    description: (
      <nav>
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/Pragtical-v3.2.0-x86_64.AppImage'>
            AppImage
          </a>
          &nbsp;
          <code>64 bit</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-linux-x86_64-portable.tar.gz'>
            Portable ZIP
          </a>
          &nbsp;
          <code>64 bit</code>
  ...
  },
  {
    ...
    description: (
      <nav>
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/Pragtical-v3.2.0-x86_64-setup.exe'>
            Installer
          </a>
          &nbsp;
          <code>64 bit</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-windows-x86_64.zip'>
            Portable ZIP
          </a>
          &nbsp;
          <code>64 bit</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/Pragtical-v3.2.0-i686-setup.exe'>
            Installer
          </a>
          &nbsp;
          <code>32 bit</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-windows-i686.zip'>
            Portable ZIP
          </a>
          &nbsp;
          <code>32 bit</code>
  ...
  },
  {
    ...
    description: (
      <nav>
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-macos-universal.dmg'>
            DMG
          </a>
          &nbsp;
          <code>Universal</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-macos-x86_64.dmg'>
            DMG
          </a>
          &nbsp;
          <code>Intel</code>
        ...
        <li className={styles.li}>
          <a href='https://github.com/pragtical/pragtical/releases/download/v3.2.0/pragtical-v3.2.0-macos-arm64.dmg'>
            DMG
          </a>
          &nbsp;
          <code>Arm</code>
    ...
    <main>
      <section className={styles.downloads}>
        <div className="container">
          <h1 style={{textAlign:"center"}}>v3.2.0 Builds</h1>
